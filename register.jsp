...
<%
	...
	String dbUrl = "jdbc:mysql://39.108.222.163/term?serverTimezone=CST&useUnicode=true&characterEncoding=UTF8"; // MySQL 資資資資資資資
	boolean WK_Message = false;
	String SQLString = "insert into myuser values('";
	SQLString += username + "', '" + password + "', '" + email + "')";
...
<html>
  ...
  <body>
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top"><a href="index.html" class="navbar-brand">ManageSystem</a>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          ...
          <div class="navbar-text">   
          	<a href="#" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary navbar-btn btn-shadow btn-gradient">Login Now</a>
          </div>
        </div>
      </nav>
    </header>
      ...
      <div role="document" class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 id="exampleModalLabel" class="modal-title">Login Now</h5>
            <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
          </div>
          <!----------------lOGIN Now------------------- -->
          <div class="modal-body">
            <form id="signupform" method="POST" action="home.jsp"><!----------------lOGIN Now------------------- -->
              <div class="form-group">
                <label for="username">Username</label>
                <input type="text" name="Username" placeholder="Username" id="fullname">
              </div>
              <div class="form-group">
                <label for="username">Password</label>
                <input type="text" name="Password" placeholder="Password" id="username">
              </div>
              <div class="form-group"><!--加入一个验证成功跳转页面。-->
      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-lg-6 text order-2 order-lg-1">
            <h1>WE ARE BEST</h1>
            <p class="hero-text">There are many stories to share with you</p>
            <div class="CTA">
            	<a href="#features" class="btn btn-primary btn-shadow btn-gradient link-scroll">Discover More</a>
            	<a href="register.html" class="btn btn-outline-primary">Sign Up Now</a></div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2"><img src="img/background.jpg" alt="..." class="img-fluid"></div>
        </div>
      </div>
    </section>
