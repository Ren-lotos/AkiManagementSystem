...
<%
    ...
    String WK_Message = "";
    String SQLString = "update myout set name='" + name + "', date='" + date + "', state='" + state + "', price='" + price + "', num='" + num + "', customer='" + customer + "', goods='" + goods + "' where id='" + id + "'";
    ...
    try {
        ...
        if(conn != null) {
            ...
            stat.close();
            conn.close(); // 关闭资料库连线
           WK_Message = "资料库更新资料成功";
        } else {
            WK_Message = "资料库连线失败";
        }
    } catch(Exception ex) {
        WK_Message = "资料库更新资料失败" + ex;
    }
%>
<html lang="utf-8">
