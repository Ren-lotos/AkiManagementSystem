...
<%
    ...
    String SQLString = "select * from myin";
...
<%
    try {
        ...
        if(conn != null) {
            ...
            out.println(" <td width='10%' align='center'><font color='#FFFFFF'>供应商</font></td>");
            ...
            while(rs.next()) {
                ...
                out.println(" <td align='center'>" +  rs.getString("store") + "</td>");
                out.println(" <td align='center'> <a href='UpdateDataIn.jsp?id=" +  rs.getString("id") + "'>修改</a> <a href='DeleteDataIn.jsp?id=" +  rs.getString("id") + "'>删除</a></td>");
                out.println(" </tr>");
            } 
            rs.close();
            stat.close();
