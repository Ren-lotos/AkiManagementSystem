...
<%
    ...
    String dbUrl = "jdbc:mysql://39.108.222.163/term?serverTimezone=CST&useUnicode=true&characterEncoding=UTF8"; // MySQL 资料库连接字串
    ...
    try {
        ...
        if(conn != null) {
            ...
            ResultSet rs = stat.executeQuery("select * from myout where id='" + id + "'");
            if(rs.next()) {
...
<body>
    ...
    <div class="content-wrap">
        <div class="main">
			...
			<form name="form1" method="POST" action="UpdateDataOut2.jsp">
				请输入更新资料
				<table width="85%" border="0">
					<tr>
						...
						<td align="left" bgcolor="#CCFFFF">
							<%=WK_Data[0]%><input type="hidden" name="id" value="<%=WK_Data[0]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="goods" size="100" maxlength="100" value="<%=WK_Data[1]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="name" size="100" maxlength="100" value="<%=WK_Data[2]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="date" size="100" maxlength="100" value="<%=WK_Data[3]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="state" size="100" maxlength="100" value="<%=WK_Data[4]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="price" size="100" maxlength="100" value="<%=WK_Data[5]%>">
                        </td>
					</tr>
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="num" size="100" maxlength="100" value="<%=WK_Data[6]%>">
                        </td>
					</tr> 
					<tr>
						<td align="right" width="25%">
						...
						<td align="left" bgcolor="#CCFFFF">
                            <input type="text" name="customer" size="100" maxlength="100" value="<%=WK_Data[7]%>">
                        </td>
					</tr>         
				</table>
                <div class="row" style="margin-top: 2%">
                    <center>
				    <input type='submit' value='确认更新' name='B1'> <input type="reset" value="重新输入" name="B2">
                    </center>
                </div>
		    </form>
                    <!-- /# row -->
