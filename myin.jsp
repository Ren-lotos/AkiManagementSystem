...
<%
    ...
    String WK_Message = "";
    String SQLString = "insert into myin values('";
    SQLString += id + "', '" + name + "', '" + date + "', '" + state + "', '" + price + "', " + num + ", '" + store + "', '" + goods + "')";
    ...
    try {
        ...
        if(conn != null) {
            ...
            SQLString = "select * from myin where id='" + id + "'";
        ...
        WK_Message = "新增进货单失败" + ex + SQLString;
    }
%>
<html lang="utf-8">
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="main-content">
                    <form name="form1" method="POST" action="UpdateDataIn.jsp">
